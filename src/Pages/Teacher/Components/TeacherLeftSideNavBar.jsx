...
<<<<<<< HEAD
        <Link to="/teacher/students" className="colorNavChange flex items-center p-4 rounded cursor-pointer">
          <FaUser className="text-xl textColor text-blue-600 colorNavChange" />
          {isExpanded && <span className="ml-4 textColor">Students</span>}
        </Link>
...
>>>>>>> 40608f5c71c8fd857f6e062fd65bd20684d61de9
        </Link>
        </li>   
        <li className="bGcolor">
